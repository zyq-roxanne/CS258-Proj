...
# Error Correction Level in Binary Indicator
ERR_CORR_L = 1
ERR_CORR_M = 0
ERR_CORR_Q = 3
ERR_CORR_H = 2
...
# Mode Indicators
NUMERIC_MODE = 1 << 0
ALPHANUMERIC_MODE = 1 << 1
EIGHT_BIT_BYTE_MODE = 1 << 2
KANJI_MODE= 1 << 3

MODE_INDICATORS = (NUMERIC_MODE,
                ALPHANUMERIC_MODE,
                EIGHT_BIT_BYTE_MODE,
                KANJI_MODE,)
...
# p18-table3-qr_standard_editable.pdf
MODE_SIZE_SMALL = {
    # 1 to 9
    NUMERIC_MODE: 10, # numeric data (digits 0-9)
    ALPHANUMERIC_MODE: 9, # alphanumeric data (digits 0-9; upper case letter A-Z; none other characters: \space, $%*_-./:)
    EIGHT_BIT_BYTE_MODE: 8, # 8-bit byte data
    KANJI_MODE: 8, # 13-bit Kanji characters
}
MODE_SIZE_MEDIUM = {
    # 10 to 26
    NUMERIC_MODE: 12,
    ALPHANUMERIC_MODE: 11,
    EIGHT_BIT_BYTE_MODE: 16,
    KANJI_MODE: 10,
}
MODE_SIZE_LARGE = {
    # 27 to 40
    NUMERIC_MODE: 14,
    ALPHANUMERIC_MODE: 13,
    EIGHT_BIT_BYTE_MODE: 16,
    KANJI_MODE: 12,
}
...
ALPHANUMERIC_NUM = b'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:'
RE_ALPHANUMERIC_NUM = re.compile(b'^[' + re.escape(ALPHANUMERIC_NUM) + br']*\Z')
